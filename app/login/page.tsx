    ...
    <main className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--bg-soft)' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl p-8" style={{ background: 'white', border: '1px solid var(--line)' }}>
          <h1 className="text-xl font-bold mb-1" style={{ color: 'var(--ink)' }}>Log in</h1>
          <p className="text-sm mb-6" style={{ color: 'var(--muted)' }}>Welcome back to your business dashboard.</p>
          ...
          <p className="text-xs text-center mt-6" style={{ color: 'var(--muted)' }}>
            No account? <a href="/signup" className="font-semibold" style={{ color: 'var(--ink)' }}>Start free trial</a>
          </p>
        </div>
      </div>
    </main>
